  ...
  return (
    <div className="bg-white rounded-lg shadow hover:shadow-lg transition overflow-hidden flex flex-col">
      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        <div>
          <div className="font-semibold text-lg text-gray-800 line-clamp-2">{product.ItemName}</div>
          {product.Size && (
            <div className="text-sm font-semibold text-primary mt-2">Type: {formatDisplayText(product.Size)}</div>
          )}
          <div className="text-sm text-gray-500 mt-1">Brand: {formatDisplayText(product.Brand)}</div>
        ...
        <div className="mt-2 flex flex-col gap-2">
          ...
          <div className="text-sm text-gray-500">SRP: {product.MSRP}</div>
